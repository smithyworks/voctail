...
server.post("/api/add-classroom-documents", auth.tokenMiddleWare, classrooms.addDocumentsHandler);
// old
...
server.post("/api/delete-section", auth.tokenMiddleWare, classrooms.deleteSection);
