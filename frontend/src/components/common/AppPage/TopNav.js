...
function TopNav({ loggedIn, isAdmin, masquerading, premium, pendingTranslations }) {
  const classes = useStyles();

  const navButtons = loggedIn ? <NavButtons isAdmin={isAdmin} pendingTranslations={pendingTranslations} /> : null;
