INSERT INTO documents (title, description, isPublic, content, author) VALUES
    ('A Bohemian Scandal', 'This is the description of "A Bohemian Scandal"', true, 'To Sherlock Holmes she is always the woman. I have seldom heard him mention her under any other name. In his \
     ...
     that woman was the late Irene Adler, of dubious and questionable memory.', 'Arthur Conan Doyle'),

('A Bohemian Scandal II', 'This is the description of "A Bohemian Scandal" II', true, 'I had seen little of Holmes lately. My marriage had drifted us away from each other. My own complete \
      ...
      friend and companion.', 'Arthur Conan Doyle');
